...
describe("Queries Across Tables", () => {
  ...
  it(
    ...
    async done => {
      const query = `SELECT Round(SUM(movies.budget_adjusted),2) AS total_budget, directors.full_name AS director FROM movies
  ...
  it(
    ...
    async done => {
      const query = `SELECT COUNT(*) AS count, keywords.keyword AS keyword FROM movie_keywords
  ...
  it(
    ...
    async done => {
      const query = `SELECT COUNT(*) AS count, original_title FROM movies
  ...
  it(
    ...
    async done => {
      const query = `SELECT genres.genre, COUNT(*) AS five_stars_count FROM movies
  ...
  it(
    ...
    async done => {
      const query = `SELECT genres.genre AS genre, Round(AVG(movie_ratings.rating),2) AS avg_rating FROM movies
      INNER JOIN genres ON genres.id = movie_genres.genre_id 
      INNER JOIN movie_genres ON movie_genres.movie_id = movies.id
      INNER JOIN movie_ratings ON movie_ratings.movie_id = movies.id 
      GROUP BY genre
